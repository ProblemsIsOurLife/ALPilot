    ...
    public partial class Form1 : Form
    {
        ...
        public class bot
        {
                ...
                while (delivered == false)
                {
                     ...
                     /*if (center[0].X == 0)
                    {
                       ...
                       Task.Delay(1000).Wait();
                        ...
                        center = FindCountour( ref images.queuefull, "queuefull");
                        if (center[0].X == -1)
                        {
                            return -1;
                        }
            ...
            int checkmass(IntPtr HWIDch)
            {
                ...
                inputImage.Dispose();
                if (temppixel.R >= 25 && temppixel.G >= 75 && temppixel.B >= 60)
                {
                    return 1;
                }
            ...
            Point[] FindCountour(ref Image<Bgr, byte> imageToFind, string position)
            {
                ...
                Rectangle rect = new Rectangle(100, 100, 900, 600);
                sector2 = image.Copy(rect);
                Image<Gray, float> result1 = sector2.MatchTemplate(images.androiderror, Emgu.CV.CvEnum.TemplateMatchingType.CcoeffNormed);
                ...
                switch (position)
                {
                    ...
                    case "kernite":
                        {
                            sectorpos = new Rectangle(800, 0, 200, 768);
                            sector = image.Copy(sectorpos);
                            break;
                        }
                    case "crokite":
